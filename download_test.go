...
func TestDownload(t *testing.T) {
	...
	f2, e2 := filemanagement.DownloadFileToBase64("https://www.africau.edu/images/default/sample.pdf", false)
	assert.Equal(t, nil, e2)
	assert.Equal(t, filemanagement.ReadFileToBase64NoError("./files/pdf_1.pdf"), f2)
}
